...
@section('content')
    ...
    <div class="container" style="max-width: 900px;margin-top: 30px;margin-bottom: 50px">
        ...
        @endif
        <h3 style="letter-spacing: 3px;margin-top: 20px" class="mt-4 mb-3">TOURS</h3>
            <div>
                <a href="{{url('add-tour')}}" class="btn btn-success">ADD NEW TOUR</a>
            </div>
...
{{--                    <th>Address</th>--}}
                ...
                @if(count($tours) != 0)
                    @foreach($tours as $key => $item)
                        <tr>
                            <td><img width="200px" height="50" src="{{url('show-tour-image')}}/{{$item->id}}"></td>
                            <td>{{$item->title}}</td>
                            <td>{{$item->price}}</td>
...
{{--                        <td></td>--}}
                        <td></td>
                        <td class="text-center">No Tours Found Yet!</td>
                        <td></td>
                        <td></td>
                    </tr>
                @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h3 class="modal-title" id="resetheading">Add New Office</h3>
                </div>

                <!-- Modal body -->
                <div class="modal-body">
{{--                    <h5>Reset Password</h5>--}}
                    <form action="{{url('add-new-office')}}" method="post">
                        @csrf
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
